<template>    
    <header class="relative bg-white">
        <p class="flex h-10 items-center justify-center bg-emerald-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">Get free delivery on orders over $100</p>
...
const products = [
  {id: 1, name: 'T-shirt 1', price: 10, qty: 1},
  {id: 2, name: 'T-shirt 2', price: 20, qty: 1},
  {id: 3, name: 'T-shirt 3', price: 30, qty: 1},
  {id: 4, name: 'T-shirt 4', price: 40, qty: 1},
];
</script>
